        ...
        {!profile || editing ? (
          <div className="space-y-4">
            ...
            <div className="flex gap-2 pt-2">
              <Button onClick={save}>
                <Save className="h-4 w-4<dyad-write path="src/routes/app.profiles.tsx" description="Complete fixed profiles page with proper types">
import { createFileRoute } from "@tanstack/react-router";
import { useState, useEffect } from "react";
import { useQuery, useQueryClient } from "@tanstack/react-query";
import { supabase } from "@/integrations/supabase/client";
            ...
            <div className="rounded-xl bg-surface-2 p-4">
              ...
              <div className="font-mono tabular text-2xl font-bold">
                {profile?.monthly_budget
                  ? formatBRL(Number(profile.monthly_budget))
                  : "Não definido"}
              </div>
            </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Em desenvolvimento — metas de economia e investimento estarão disponíveis em breve.
            </p>
